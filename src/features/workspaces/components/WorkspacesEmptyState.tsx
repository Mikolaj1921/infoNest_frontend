...
export const WorkspacesEmptyState = () => {
  return (
    <div className="flex min-h-[500px] flex-col items-center justify-center text-center p-8 border border-dashed border-border rounded-2xl bg-card/10 backdrop-blur-sm max-w-xl mx-auto my-12 animate-in fade-in duration-500">
      ...
      <button className="mt-6 flex items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-bold text-primary-foreground hover:opacity-90 active:scale-[0.98] transition-all cursor-pointer shadow-lg shadow-primary/20">
